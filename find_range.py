...
DATA_PATH = r"D:\Unversity of Toronto\UTRA\Stop Sign Dataset"
FILE_TYPE = ".jpg"
START_INDEX = 1
END_INDEX = 200
...
def main(input_path=DATA_PATH):
    ...
    for i in range(START_INDEX, END_INDEX+1):
        src = input_path + "\\" + str(i) + FILE_TYPE
        print(src)
        og = image_tools.scale(cv2.imread(src), 800)
        ...
        while (1):
            ...
            box, contours, img = image_tools.get_bbox(og)
            temp = og.copy()
